const CaseCard = ({ title, summary, img, url, date }) => {
  return (
    <a className="cursor-pointer" href={url}>
      <div className="group relative flex h-[30rem] w-full items-end overflow-hidden rounded-2xl xl:h-[36rem] 3xl:h-[40rem]  ">
        <div
          id="imgContainer"
        ...
        <div className="z-10 flex h-[50%] flex-col justify-end bg-gradient-to-b from-alpha/0 to-alpha/[90] p-6">
          ...
          <p className="z-10 mb-4 text-white lg:text-sm">{summary}</p>
